...
Checkpointer also cleans up old files, maintaining up to the checkpoint_keep_max
...
class Checkpointer(object):
    ...
    def __init__(self, base_directory, checkpoint_file_prefix='ckpt',
                checkpoint_frequency=1, checkpoints_keep_max=4):
        ...
        self._checkpoints_keep_max = checkpoints_keep_max
    ...
    def _clean_up_old_checkpoints(self, iteration_number):
        ...
        # that are checkpoints_keep_max * self._checkpoint_frequency versions old.
        stale_iteration_number = \
            iteration_number \
                - (self._checkpoint_frequency * self._checkpoints_keep_max)
        ...
        if stale_iteration_number >= 0:
            ...
            try:
                ...
                tf.logging.info('Unable to remove {} or {}.'.format(
                    stale_file, stale_sentinel))
